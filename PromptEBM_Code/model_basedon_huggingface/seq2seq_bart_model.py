#sys.path.append('../transformers/src/transformers')
import logging
import math
import os
import random
...
class Seq2SeqModel:
    def __init__(
        ...
        **kwargs,
        ...
        ##note: looks the following first line is good. But we need to call from command line with,
        ##[ec2-user@ip-10-0-10-12 paraphrase_bart_transformer]$ python -m torch.distributed.launch paraphrase_simpletransformers.py
