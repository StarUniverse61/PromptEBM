...
echo ==================== "this is experiments_five_task_gpu.sh" ====================
...
do
        ...
        bash run_full_parameters.sh $cuda ./data $SAVE $seq_train_type ${task_group[$i]} ${model_arr[$i]} $gamma $pretrain_cof $encoder_norm_self $decoder_norm_self $encoder_norm_ff $decoder_norm_ff $batch_size
        i=$(($i+1))
done
