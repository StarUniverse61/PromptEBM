...
import numpy as np
from model_basedon_huggingface.EBM_NR_LAMOL.ebm_models.dgmvae.utils import Pack
from model_basedon_huggingface.EBM_NR_LAMOL.ebm_models.dgmvae.dataset.dataloader_bases import DataLoader

class QADataLoader(DataLoader):

    def __init__(self, name, data, config, max_utt_len=-1):
        super(QADataLoader, self).__init__(name, fix_batch=config.fix_batch)
