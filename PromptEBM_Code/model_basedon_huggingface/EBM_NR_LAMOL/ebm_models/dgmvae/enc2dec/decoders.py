...
from model_basedon_huggingface.EBM_NR_LAMOL.ebm_models.dgmvae.enc2dec.base_modules import BaseRNN
from model_basedon_huggingface.EBM_NR_LAMOL.ebm_models.dgmvae.utils import FLOAT, LONG, cast_type
...
class DecoderRNN(BaseRNN):
    ...
    def forward4lamol(self, batch_size, inputs=None, init_state=None,
                attn_context=None, mode=TEACH_FORCE, gen_type='greedy',
                beam_size=4, latent_variable=None):
