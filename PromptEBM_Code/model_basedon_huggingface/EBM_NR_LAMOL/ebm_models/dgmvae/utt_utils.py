...
from model_basedon_huggingface.EBM_NR_LAMOL.ebm_models.dgmvae import utils
...
def generate4lamol(ebm_model, data_feed, mode,gen_type='greedy'):
    ...
    dec_outs, posterior_sample_n, sample_z, dec_init_state = ebm_model.forward4lamol(data_feed,
                                                          vae_kl_weight=1.,
                                               gen_type=gen_type,
                                                        mode=mode)
