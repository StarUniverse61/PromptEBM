#!/bin/bash
nohup bash ./experiments_five_tasks_gpu.sh 0 lll sst,srl,woz.en,squad2,wikisql-srl,sst,woz.en,wikisql,squad2-woz.en,sst,srl,wikisql,squad2  openai-gpt,openai-gpt,openai-gpt 0.05 500 power power layer layer ppll 16 3 >& experiments_five_tasks_gamma02_pretraincof500_adamw_openaigpt_ppll_gpu0.nohup &
nohup bash ./experiments_five_tasks_gpu.sh 1 lll sst,srl,woz.en,squad2,wikisql-srl,sst,woz.en,wikisql,squad2-woz.en,sst,srl,wikisql,squad2  openai-gpt,openai-gpt,openai-gpt 0.05 500 layer layer layer layer llll 16 3 >& experiments_five_tasks_gamma02_pretraincof500_adamw_openaigpt_llll_gpu1.nohup &
nohup bash ./experiments_five_tasks_gpu.sh 2 lll sst,srl,woz.en,squad2,wikisql-srl,sst,woz.en,wikisql,squad2-woz.en,sst,srl,wikisql,squad2  gpt2,gpt2,gpt2 0.05 500 power power layer layer ppll 16 3 >& experiments_five_tasks_gamma02_pretraincof500_adamw_gpt2_ppll_gpu2.nohup &
nohup bash ./experiments_five_tasks_gpu.sh 3 lll sst,srl,woz.en,squad2,wikisql-srl,sst,woz.en,wikisql,squad2-woz.en,sst,srl,wikisql,squad2  gpt2,gpt2,gpt2 0.05 500 layer layer layer layer llll 16 3 >& experiments_five_tasks_gamma02_pretraincof500_adamw_gpt2_llll_gpu3.nohup &
