...
class MLP(nn.Module):
    ...
    def forward(self, x):
        # logger.info(f'x of forward of MLP in modeling_gpt2.py and the shape of x is {x.shape}')
        #print(x)
        #logger.info(x)
        h = self.act(self.c_fc(x))
        # logger.info(f'h of forward of MLP in modeling_gpt2.py and the shape of h is {h.shape}')
        # print(x)
        #logger.info(h)
        h2 = self.c_proj(h)
        # logger.info(f'h2 of forward of MLP in modeling_gpt2.py and the shape of h2 is {h2.shape}')
        # print(x)
        #logger.info(h2)
...
class Block(nn.Module):
    ...
    def forward(self, x, layer_past=None, head_mask=None):
        ...
        x = x + a
        #logger.info(f'x.shape of Block {x.shape}')
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.ln_f = NormSelect(config.pretrained_config_archive_map['encoder_norm_self'], config.n_embd, config.num_attention_heads,
                                               config.pretrained_config_archive_map['warmup_updates'])
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, position_ids=None, token_type_ids=None, labels=None, past=None, head_mask=None):
        ...
        #logger.info('will come here in modeling_gpt2.py')
