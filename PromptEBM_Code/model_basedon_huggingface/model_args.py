...
class ModelArgs:
    ...
    max_seq_length: int = 64 ## 128 is the original one, looks too large
    model_name: str = None
    model_type: str = None
    ...
    encoder_norm_self: str = 'power'
    encoder_norm_ff: str = 'power'
    decoder_norm_self: str = 'layer'
    decoder_norm_ff: str = 'layer'
