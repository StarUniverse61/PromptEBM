...
def parse_args():
    ...
    parser.add_argument("--seq_train_type", type=str, default="lll", choices=["lll","finetune","multitask","mas","ewc","gem","pn_calibration"])
    ...
    parser.add_argument("--encoder_norm_self", type=str, default="layer", choices=["layer", "power", "batch"])
    parser.add_argument("--decoder_norm_self", type=str, default="layer", choices=["layer", "power", "batch"])
    parser.add_argument("--encoder_norm_ff", type=str, default="layer", choices=["layer", "power", "batch"])
    parser.add_argument("--decoder_norm_ff", type=str, default="layer", choices=["layer", "power", "batch"])
