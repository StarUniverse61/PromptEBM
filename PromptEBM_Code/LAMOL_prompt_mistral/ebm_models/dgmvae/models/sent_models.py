...
from LAMOL_prompt_mistral.ebm_models.dgmvae import criterions
from LAMOL_prompt_mistral.ebm_models.dgmvae.enc2dec.decoders import DecoderRNN
from LAMOL_prompt_mistral.ebm_models.dgmvae.enc2dec.encoders import EncoderRNN
from LAMOL_prompt_mistral.ebm_models.dgmvae.utils import INT, FLOAT, LONG, cast_type
from LAMOL_prompt_mistral.ebm_models.dgmvae import nn_lib
import numpy as np
from LAMOL_prompt_mistral.ebm_models.dgmvae.models.model_bases import BaseModel
from LAMOL_prompt_mistral.ebm_models.dgmvae.enc2dec.decoders import GEN, TEACH_FORCE
from LAMOL_prompt_mistral.ebm_models.dgmvae.utils import Pack, kl_anneal_function, interpolate, idx2onehot
import itertools
import math
import logging
...
class GMVAE4Lamol(BaseModel):
    ...
    def forward4lamol(self, data_feed, vae_kl_weight, gen_type, mode):
        ...
        out_utts = self.np2var(data_feed, LONG)
...
class SVAE(BaseModel):
    concat_decoder_input: Union[bool, Any]
