...
from ebm_models.dgmvae.utils import str2bool
import GPUtil
...
from transformers import AutoModelForCausalLM, AutoTokenizer, MistralConfig, MistralForCausalLM
import torch
from ebm_models.dgmvae.models.sent_models import GMVAE, GMVAE4Lamol
...
def add_default_progressiveprompts_parser(parser):
    parser.add_argument(
        '--save_dir',
        type=str,
...
def get_parser(model_class="sent_models"):
    ...
    parser.add_argument("--prompt_lambda", type=float, default=0.05)
    ...
    parser.add_argument("--seq_train_type", type=str, default="lll", choices=["lll","finetune","multitask","mas","ewc","gem", "ebm"])
    ...
    parser.add_argument('--ebm_model_file', type=str,
                        default='/home/xiaodi/NLP/Lifelonglearning-main/Lifelonglearning_For_NLG_v3/ibebm/logs/ptb/dgmvae/2023-12-31T15-24-51-text_generation_from_pretrained.py/')
    # parser.add_argument('--ebm_model_file', type=str,
    #                     default='/home/xiaodi/NLP/Lifelonglearning-main/Lifelonglearning_For_NLG_v3/ibebm/logs/ptb/dgmvae/2022-12-31T00-03-38-text_generation_from_pretrained.py/model_ckpt.pt')
    ...
    parser = add_default_progressiveprompts_parser(parser)
